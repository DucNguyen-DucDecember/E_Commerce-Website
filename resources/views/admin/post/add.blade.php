        ...
        <div class="card-body">
            <form action="{{url('admin/post/store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="post_excerpt" class="form-control" id="content" cols="30" rows="5"
                        value="{{old('post_excerpt')}}"></textarea>
                    @error('post_excerpt')
                        <small class="text-danger">{{$message}}</small>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <textarea name="post_content" class="form-control" id="post_content" cols="30" rows="5"
